...
const ComboboxDemo: React.FC<ComboboxDemoProps> = ({ setValue, value, id ,setid}) => {
  ...
  if (isLoading) {
    return (
      <Popover open={open} onOpenChange={setOpen}>
        ...
        <PopoverContent className="w-[200px] max-md:w-full  p-0 border bg-white ">
  ...
  return (
    <Popover open={open} onOpenChange={setOpen}>
      ...
      <PopoverContent className="w-[200px] p-0 border bg-white">
        ...
        <Command>
          <CommandInput placeholder="جستوجو..." className="h-9 border-b border-gray-200 px-2" />
          <CommandList>
