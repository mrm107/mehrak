  ...
  return (
    <div className="px-14 max-md:px-4">
      <div className="mt-8 flex items-center justify-between w-full relative">
        ...
        <p className="text-darkGray md:text-2xl text-base text-center w-full">
          کد تایید
        </p>
      </div>
      <p className="mt-9 text-aquaBlue md:text-lg text-sm font-medium">
        کد تایید برای شماره {phoneNumber} پیامک شد
      </p>
      <p className="text-base text-darkGray mt-7 md:text-lg font-normal">
        ...
        <div className="space-y-2">
          ...
          >
            <InputOTPGroup autoFocus className="flex gap-4">
              <InputOTPSlot
                autoFocus
                className="md:rounded-2xl rounded-xl border border-vibrantOrange md:size-14"
                index={5}
              />
              <InputOTPSlot
                className="md:rounded-2xl rounded-xl border border-vibrantOrange md:size-14"
      ...
      <div className="flex w-full justify-center mt-8 flex-col items-center">
        ...
        <Button
          ...
          className="bg-aquaBlue w-[299px] max-md:h-[44px] h-[48px] hover:bg-teal-500 mb-12 px-[135px] py-3 max-md:w-full mt-16 rounded-md transition-all duration-300 transform hover:scale-105 active:scale-95"
        >
          {loading ? (
